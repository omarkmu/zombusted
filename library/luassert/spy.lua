...
---@overload fun(callback?: function): luassert.spy

---Spies allow you to wrap a function in order to
---track how that function was called.
---### Example
---```
...
--- end)
---```
local spy_factory = {} ---@class luassert.spy.factory
...
---```
---
---@param callback? function The function to spy on
---@return luassert.spy spy A spy object that can be used to perform assertions
function spy_factory.new(callback) end
...
---@return_cast object luassert.spy
